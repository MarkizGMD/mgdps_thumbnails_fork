...
void ThumbnailPopup::onDownload(CCObject* sender){
    std::string URL = fmt::format("https://raw.githubusercontent.com/MarkizGMD/markizgdps_thumbnails/main/thumbs/{}.png", m_levelID);
...
void ThumbnailPopup::openDiscordServerPopup(CCObject* sender){
    ...
    createQuickPopup(
        ...
        [this](auto, bool btn2) {
            if (btn2) {
                CCApplication::sharedApplication()->openURL("https://discord.gg/6JAWpvk3");
            }
        }
    );
}
